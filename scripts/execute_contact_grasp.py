...
if frames:
    video = build_frame_sequence_video(
        ...
        crf=17,
        preset="slow",
        purpose="rg6_contact_physics_validation",
    )

result = {
    "schema_version": "rg6-contact-grasp-validation-v1",
    ...
    "evaluation_scope": (
        "Single deterministic contact-pipeline validation."
    ),
}
