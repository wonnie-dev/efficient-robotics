...
CAPTURE_CONFIG = ROOT / "configs/research/icra_v20_five_scenario_development_20episode.json"
CAPTURE_ROOT = ROOT / "outputs/live_pipeline/icra_v20_five_scenario_development_20episode"
PERCEPTION_ROOT = ROOT / "outputs/calibration/icra_v20_five_scenario_development_perception"
AUDIT_ROOT = ROOT / "outputs/development/icra_v20_five_scenario_grounding_candidate_audit"
SELECTION_ROOT = ROOT / "outputs/development/icra_v20_five_scenario_candidate_selection"
STATE_PATH = ROOT / "outputs/development/icra_v20_five_scenario_preflight_pipeline/status.json"
GPU_IDS = (0, 2, 4, 5)
...
def main() -> None:
    state: dict[str, Any] = {
        "schema_version": "icra-v20-five-scenario-preflight-pipeline-status-v1",
    ...
    try:
        ...
        run(
            [
                sys.executable,
                "scripts/run_icra_v16_calibration_perception_sharded.py",
                "--gpu-ids",
        ...
        run(
            [
                sys.executable,
                "scripts/evaluate_icra_v20_candidate_selection.py",
                "--audit-root",
                str(AUDIT_ROOT),
                "--output-root",
                str(SELECTION_ROOT),
