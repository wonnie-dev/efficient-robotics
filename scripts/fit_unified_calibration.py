#!/usr/bin/env python3
"""Fit the joint observation model and replay the unified planner by cross-validation."""
...
DEFAULT_OUTPUT_ROOT = ROOT / "outputs/calibration/joint_model"
...
def write_auxiliary_calibration_candidates(
    ...
    *,
    ...
    write_json(
        ...
        {
            "schema_version": "scene-conditioned-view-model-candidate-v1",
    ...
    write_json(
        ...
        {
            "schema_version": "resolution-likelihoods-candidate-v1",
            "status": "calibration_candidate_not_frozen",
