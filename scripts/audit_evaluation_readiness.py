#!/usr/bin/env python3
"""Audit whether a calibration candidate is ready to freeze for testing."""
...
DEFAULT_CANDIDATE = (
    ROOT / "outputs/calibration/joint_model"
)
DEFAULT_PHYSICAL = (
    ROOT / "outputs/calibration/physical_execution/result.json"
)
DEFAULT_DEVELOPMENT = (
    ROOT
    / "outputs/development/persistent_negative_evidence"
...
def run(
    ...
    blockers = [
        ...
        {
            "name": "candidate_live_end_to_end_validation_not_run",
            "requires_gpu": True,
            "reason": (
        ...
        },
        {
            ...
            "requires_gpu": True,
            "reason": (
                "The SAM2.1 and newer-SAM comparison must be completed on the same "
                "held-out perception images before the perception stack is frozen. "
    ...
    result = {
        "schema_version": "evaluation-readiness-audit-v1",
