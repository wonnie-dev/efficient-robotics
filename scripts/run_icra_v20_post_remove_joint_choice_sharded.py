...
RUNNER = ROOT / "scripts/run_icra_v20_post_remove_joint_choice.py"
EVALUATOR = ROOT / "scripts/evaluate_icra_v20_post_remove_joint_choice.py"
PYTHON = Path(
    os.environ.get(
...
def main() -> None:
    ...
    state = {
        "schema_version": "icra-v20-post-remove-joint-choice-sharded-status-v1",
        "status": "running",
