#!/usr/bin/env python3
"""Replay the frozen V15b belief-space MPC on the reserved test cache."""
...
DEFAULT_PERCEPTION_ROOT = (
    ROOT / "outputs/final_evaluation/icra_v15b_reserved_test/perception"
)
DEFAULT_FREEZE_ROOT = ROOT / "outputs/calibration/icra_v15b_frozen_before_test"
DEFAULT_OUTPUT_ROOT = (
    ROOT / "outputs/final_evaluation/icra_v15b_reserved_test/policy_evaluation"
)
...
def run(perception_root: Path, freeze_root: Path, output_root: Path) -> dict[str, Any]:
    ...
    result = {
        "schema_version": "icra-v15b-reserved-test-frozen-mpc-evaluation-v1",
        "status": "completed",
