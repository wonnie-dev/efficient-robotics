...
* legacy RGB-only view-observable labels used by the Qwen adapter.
...
DEFAULT_CONFIG = (
    ROOT / "configs/perception/rgbd_relation_calibration.json"
)
...
def run(config_path: Path) -> dict[str, Any]:
    ...
    result = {
        "schema_version": "rgbd-relation-calibration-summary-v1",
