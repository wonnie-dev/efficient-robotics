...
from calibrate_joint_observation_model import INFORMATION_ACTIONS, build_rows
from evaluate_scene_conditioned_planner import replace_symbols
...
def main() -> None:
    ...
    result = {
        "schema_version": "direct-vlm-baseline-evaluation-v1",
        "status": "completed",
