"""Live RGB-D tracking adapters for the V13 joint-belief planner."""
...
from run_live_learned_scanned_basket_pipeline import resolve_input_asset
...
def tracked_joint_observation_row(
    ...
    *,
    ...
    audit = {
        "schema_version": "v13-rgbd-persistent-track-observation-v1",
        "action": action,
...
def localization_payload(
    ...
    return {
        ...
        "selection": {
            ...
            "source": "v13_rgbd_nearest_center_tracking",
