#!/usr/bin/env python3
"""Cross-validate scene-conditioned sensing inside the unified V15 MPC.
...
from run_icra_v20_candidate_set_view_calibration import (
...
DEFAULT_OUTPUT = (
    ROOT
    / "outputs/calibration/icra_v15b_integrated_scene_conditioned_mpc_cv"
    / "result.json"
)
VIEW_ACTIONS = {
...
def run(
    ...
    *,
    ...
    result = {
        "schema_version": "icra-v15b-integrated-scene-conditioned-mpc-cv-v1",
