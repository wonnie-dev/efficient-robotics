#!/usr/bin/env python3
"""Collect the predeclared V15 calibration observations on GPUs 0-3."""
...
DEFAULT_CONFIG = ROOT / "configs/research/icra_v15_calibration_36episode.json"
REMOVE_RUNNER = ROOT / "scripts/run_icra_v6_stress_scene_smoke.py"
STATIC_RUNNER = ROOT / "scripts/run_actual_view_motion_smoke.py"
...
authorize_v16_reserved_test = authorize_reserved_test
...
def main() -> None:
    ...
    if authorization is not None:
        ...
        if not marker.exists():
            write_json(
                marker,
                {
                    "schema_version": "icra-v16-reserved-test-open-marker-v1",
    ...
    state: dict[str, Any] = {
        "schema_version": "icra-v15-observation-capture-status-v1",
        "status": "running",
            ...
            if row["collector"] == "remove_cover_counterfactual":
                episode_config = {
                    **config,
                    ...
                    "smoke_assignments": [{**row, "physical_gpu": 0}],
                }
