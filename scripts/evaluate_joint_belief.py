...
DEFAULT_CONFIG = ROOT / "configs/research/joint_observation_model_config.json"
HYPOTHESES = (
...
def run(config_path: Path) -> dict[str, Any]:
    ...
    result = {
        "schema_version": "joint-belief-evaluation-v1",
        ...
        "limitations": [
            ...
            "The joint observation model must be refit on the new calibration split before final evaluation.",
    ...
    development_model.update(
        {
            "schema_version": "joint-observation-model-v1",
    ...
    write_json(output_root / "joint_observation_model.json", development_model)
