#!/usr/bin/env python3
"""Compare frozen V16 policies on a cached perception split."""
...
from evaluate_icra_v15b_reserved_test import (  # noqa: E402
...
DEFAULT_DEFINITIONS = ROOT / "configs/research/icra_v16_method_definitions.json"
DEFAULT_PERCEPTION_ROOT = (
    ROOT / "outputs/final_evaluation/icra_v16_reserved_test/perception"
)
DEFAULT_FREEZE_ROOT = ROOT / "outputs/calibration/icra_v16_frozen_before_test"
DEFAULT_OUTPUT_ROOT = (
    ROOT / "outputs/final_evaluation/icra_v16_reserved_test/policy_evaluation"
)
...
def run(
    ...
    if definitions["status"] == "frozen_before_untouched_test":
        if set(episodes) != EXPECTED_TEST_SEEDS:
            raise RuntimeError("The V16 reserved-test episode set is incomplete or changed")
    ...
    result = {
        "schema_version": "icra-v16-policy-comparison-v1",
        "status": "completed",
