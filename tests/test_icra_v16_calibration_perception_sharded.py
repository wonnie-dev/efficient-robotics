"""CPU-only checks for the V16 sharded perception launcher."""
...
from run_icra_v16_calibration_perception_sharded import (  # noqa: E402
    completed_shard,
)


class IcraV16CalibrationPerceptionShardedTests(unittest.TestCase):
