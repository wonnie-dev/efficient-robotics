...
from mock_vlm_logits import build_mock_output  # noqa: E402
...
class VlmContractTests(unittest.TestCase):
    ...
    def test_mock_output_matches_contract(self) -> None:
        model_input = self.sample_input()
        validate_contract(model_input, build_mock_output(model_input))
