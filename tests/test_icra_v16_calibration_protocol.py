"""Split and scheduling contracts for V16 development calibration."""
...
class IcraV16CalibrationProtocolTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.config = json.loads(
            (ROOT / "configs/research/icra_v16_calibration_36episode.json")
